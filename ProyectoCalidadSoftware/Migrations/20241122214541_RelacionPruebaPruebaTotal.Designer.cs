...
namespace ProyectoCalidadSoftware.Migrations
{
    ...
    [Migration("20241122214541_RelacionPruebaPruebaTotal")]
    partial class RelacionPruebaPruebaTotal
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("ProyectoCalidadSoftware.Models.Prueba", b =>
                {
                    ...
                    b.Property<int>("PruebaTotalId")
                        .HasColumnType("int");

                    b.Property<int?>("PruebaTotalId1")
                        .HasColumnType("int");
                    ...
                    b.HasIndex("PruebaTotalId");

                    b.HasIndex("PruebaTotalId1");
            ...
            modelBuilder.Entity("ProyectoCalidadSoftware.Models.PruebaTotal", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("ProyectoCalidadSoftware.Models.Prueba", b =>
                {
                    ...
                    b.HasOne("ProyectoCalidadSoftware.Models.PruebaTotal", null)
                        .WithMany("Pruebas")
                        .HasForeignKey("PruebaTotalId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("ProyectoCalidadSoftware.Models.PruebaTotal", "PruebaTotal")
                        .WithMany()
                        .HasForeignKey("PruebaTotalId1");
